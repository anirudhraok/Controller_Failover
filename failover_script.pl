...
system ('curl -d {switch: "00:00:de:de:06:b0:53:4a", "name":"flow1", "cookie":"00", "priority":"32768", "ingress-port":"eth1","active":"true", "actions":"output=2"} http://192.168.164.131:8080/wm/staticflowentrypusher/json');
...
my $flowvar4 = grep(/^"actions"/,@splitvalue); 
